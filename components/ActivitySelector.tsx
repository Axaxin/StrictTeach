...
import { Unit, ActivityType, UserProgress } from '../types';
import { List, Play, ClipboardCheck, Trophy, BookOpen, ArrowLeft } from 'lucide-react';
...
const ActivitySelector: React.FC<ActivitySelectorProps> = ({ unit, progress, onSelectActivity, onBack }) => {
    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">卡片学习</h3>
          <p className="text-slate-500 text-sm">翻卡片学习单词</p>
        </button>
